...
class UserAgent:
    ...
    def produce(
        ...
        sys_prompt = (
            ...
            "When there is nothing on the UI (nothing in selection section and 0 total vehicles reported) to act on, choose STARE (do nothing), "
            "and state your intention and what kind of car you are looking for.\n\n"
            "Produce two things:\n"
